...
class EulScannerTest {
    ...
    private: static void checkIntToken(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, unsigned long expected, unsigned char size, char isUnsigned, const std::string &label) {
    ...
    private: static void checkFloatToken(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, double expected, unsigned char size, double tolerance, const std::string &label) {
    	yy::EulParser::semantic_type semantic;
    ...
    private: static void checkCharToken(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, unsigned long int expected, unsigned char size, const std::string &label) {
        yy::EulParser::semantic_type semantic;
    ...
    private: static void checkStringToken(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, const std::string& expected, const std::string &label) {
        yy::EulParser::semantic_type semantic;
    ...
    private: static void checkIdToken(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, const std::string &name, const std::string &label) {
        yy::EulParser::semantic_type semantic;
   ...
   private: static void checkTokenType(EulScanner &scanner, Compiler *comp, yy::EulParser::location_type* loc, int expected, const std::string &label) {
        yy::EulParser::semantic_type semantic;
   ...
   private: static void multiLineCommentTest(const std::string& t) {
        ...
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "A1");
        checkLocation(&loc, 1, 1, 1, 4, t + "A1_loc");
        checkIdToken(scanner, &compiler, &loc, "world", t + "A2");
        checkLocation(&loc, 2, 9, 2, 14, t + "A2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::END, t + "A3");

        //start at the end of the line. Change line during ***
        stream = std::stringstream("123/*\n*1/2***\n3*/abc\n12");
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "B1");
        checkLocation(&loc, 1, 1, 1, 4, t + "B1_loc");
        checkIdToken(scanner, &compiler, &loc, "abc", t + "B2");
        checkLocation(&loc, 3, 4, 3, 7, t + "B2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "B3");
        checkLocation(&loc, 3, 7, 4, 1, t + "B3_loc");
        checkIntToken(scanner, &compiler, &loc, 12, 4, 0, t + "B4");
        checkLocation(&loc, 4, 1, 4, 3, t + "B4_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::END, t + "B5");

        //no content comment
        stream = std::stringstream(";/**/world12");
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::SEMICOLON, t + "C1");
        checkLocation(&loc, 1, 1, 1, 2, t + "C1_loc");
        checkIdToken(scanner, &compiler, &loc, "world12", t + "C2");
        checkLocation(&loc, 1, 6, 1, 13, t + "C2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::END, t + "C3");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "D2");
        checkLocation(&loc, 1, 1, 1, 4, t + "D2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "D3");
   ...
   private: static void singleLineCommentTest(const std::string& t) {
        ...
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "A1");
        checkLocation(&loc, 1, 1, 1, 4, t + "A1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "A2");
        checkLocation(&loc, 1, 4, 2, 1, t + "A2_loc");
        checkIdToken(scanner, &compiler, &loc, "end", t + "A3");
        ...
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t +"B1");
        checkLocation(&loc, 1, 1, 1, 4, t + "B1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "B2");
    ...
    private: static void parseIntegerTest(const std::string& t) {
        ...
        EulScanner scanner(&stream);
        checkIntToken(scanner, &compiler, &loc, 1, 4, 0, t + "A1");
        checkLocation(&loc, 1, 1, 1, 2, t + "A1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::END, t + "A2");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "C1");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "D1");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 123, 8, 0, t + "E1");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 5, 123, 1, t + "F1");
        checkLocation(&loc, 1, 1, 1, 6, t + "F1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "F2");
        checkLocation(&loc, 1, 6, 1, 7, t + "F2_loc");
        checkIntToken(scanner, &compiler, &loc, 52, 2, 1, t + "F3");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 5, 4, 1, t + "G1");
        checkLocation(&loc, 1, 1, 1, 3, t + "G1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "G2");
        checkLocation(&loc, 1, 3, 1, 4, t + "G2_loc");
        checkIntToken(scanner, &compiler, &loc, 52, 4, 0, t + "G3");
        checkLocation(&loc, 1, 4, 1, 7, t + "G3_loc");
        checkIntToken(scanner, &compiler, &loc, 5, 4, 0, t + "G4");
        checkLocation(&loc, 1, 8, 1, 10, t + "G4_loc");
        checkIdToken(scanner, &compiler, &loc, "a", t + "G5");
        checkLocation(&loc, 1, 10, 1, 11, t + "G5_loc");
        checkIntToken(scanner, &compiler, &loc, 5, 4, 1, t + "G6");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 0, 4, 0, t + "H1"); //0
        checkLocation(&loc, 1, 1, 1, 2, t + "H1_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 4, 1, t + "H2"); //0u
        checkLocation(&loc, 1, 3, 1, 5, t + "H2_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 4, 0, t + "H3"); //0s
        checkLocation(&loc, 1, 6, 1, 8, t + "H3_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 123, 1, t + "H4"); //0u123
        checkLocation(&loc, 1, 9, 1, 14, t + "H4_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 123, 0, t + "H5"); //0s123
        checkLocation(&loc, 1, 15, 1, 20, t + "H5_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 4, 0, t + "H6"); //0
        checkLocation(&loc, 1, 21, 1, 22, t + "H6_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "H7"); //+
        checkLocation(&loc, 1, 22, 1, 23, t + "H7_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 12, 1, t + "H8"); //0u12
        checkLocation(&loc, 1, 23, 1, 27, t + "H8_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "H9"); //+
        checkLocation(&loc, 1, 27, 1, 28, t + "H9_loc");
        checkIntToken(scanner, &compiler, &loc, 0, 4, 0, t + "H10"); //0s
    ...
    private: static void parseFloatTest(const std::string& t) {
        ...
        EulScanner scanner(&stream);
        checkFloatToken(scanner, &compiler, &loc, 0.0, 8, 0.00000001, t + "A1");
        checkLocation(&loc, 1, 1, 1, 4, t + "A1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "A2");
        checkLocation(&loc, 1, 4, 1, 5, t + "A2_loc");
        checkFloatToken(scanner, &compiler, &loc, 1.0, 8, 0.00000001, t + "A3");
        checkLocation(&loc, 1, 5, 1, 8, t + "A3_loc");
        checkFloatToken(scanner, &compiler, &loc, 123.456, 8, 0.00000001, t + "A4");
        checkLocation(&loc, 1, 9, 1, 16, t + "A4_loc");
        checkIdToken(scanner, &compiler, &loc, "hello", t + "A5");
        checkLocation(&loc, 1, 16, 1, 21, t + "A5_loc");
        checkFloatToken(scanner, &compiler, &loc, 1.2, 8, 0.00000001, t + "A6");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkFloatToken(scanner, &compiler, &loc, 0.0, 8, 0.00000001, t + "B1");
        checkLocation(&loc, 1, 1, 1, 3, t + "B1_loc");
        checkFloatToken(scanner, &compiler, &loc, 123.0, 8, 0.00000001, t + "B2");
        checkLocation(&loc, 1, 4, 1, 8, t + "B2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "B3");
        checkLocation(&loc, 1, 8, 1, 9, t + "B3_loc");
        checkFloatToken(scanner, &compiler, &loc, 0.123, 8, 0.00000001, t + "B4");
        checkLocation(&loc, 1, 9, 1, 13, t + "B4_loc");
        checkFloatToken(scanner, &compiler, &loc, 1.0, 8, 0.00000001, t + "B5");
        checkLocation(&loc, 1, 14, 1, 16, t + "B5_loc");
        checkIdToken(scanner, &compiler, &loc, "hello", t + "B6");
        checkLocation(&loc, 1, 16, 1, 21, t + "B6_loc");
        checkFloatToken(scanner, &compiler, &loc, 2.0, 8, 0.00000001, t + "B7");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkFloatToken(scanner, &compiler, &loc, 0, 7, 0.00000001, t + "C1");
        checkLocation(&loc, 1, 1, 1, 4, t + "C1_loc");
        checkFloatToken(scanner, &compiler, &loc, 1, 32, 0.00000001, t + "C2");
        checkLocation(&loc, 1, 5, 1, 9, t + "C2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "C3");
        checkLocation(&loc, 1, 9, 1, 10, t + "C3_loc");
        checkFloatToken(scanner, &compiler, &loc, 1, 4, 0.00000001, t + "C4");
        checkLocation(&loc, 1, 10, 1, 14, t + "C4_loc");
        checkFloatToken(scanner, &compiler, &loc, 0.4, 12, 0.00000001, t + "C5");
        checkLocation(&loc, 1, 15, 1, 20, t + "C5_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN, t + "C6");
        checkLocation(&loc, 1, 21, 1, 22, t + "C6_loc");
        checkFloatToken(scanner, &compiler, &loc, 3.3, 12, 0.00000001, t + "C7");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkFloatToken(scanner, &compiler, &loc, 0, 8, 0.00000001, t + "D1");
        checkLocation(&loc, 1, 1, 1, 3, t + "D1_loc");
        checkFloatToken(scanner, &compiler, &loc, 1, 8, 0.00000001, t + "D2");
        checkLocation(&loc, 1, 4, 1, 6, t + "D2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "D3");
        checkLocation(&loc, 1, 6, 1, 7, t + "D3_loc");
        checkFloatToken(scanner, &compiler, &loc, 1.0, 8, 0.00000001, t + "D4");
        checkLocation(&loc, 1, 7, 1, 10, t + "D4_loc");
        checkFloatToken(scanner, &compiler, &loc, 0.4, 8, 0.00000001, t + "D5");
        checkLocation(&loc, 1, 11, 1, 14, t + "D5_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN, t + "D6");
        checkLocation(&loc, 1, 15, 1, 16, t + "D6_loc");
        checkFloatToken(scanner, &compiler, &loc, 3.3, 8, 0.00000001, t + "D7");
    ...
    private: static void parseIdTest(const std::string& t) {
        ...
        EulScanner scanner(&stream);
    	checkIdToken(scanner, &compiler, &loc, "hello123__", t + "A1");
    	checkLocation(&loc, 1, 1, 1, 11, t + "A1_loc");
    	checkIdToken(scanner, &compiler, &loc, "par123", t + "A2");
    	checkLocation(&loc, 1, 12, 1, 18, t + "A2_loc");
    	checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "A3");
    	checkLocation(&loc, 1, 18, 1, 19, t + "A3_loc");
    	checkIdToken(scanner, &compiler, &loc, "hello_", t + "A4");
    ...
    private: static void parseCharTest(const std::string& t) {
        ...
        EulScanner scanner(&stream);
        checkCharToken(scanner, &compiler, &loc, 'b', 1, t + "A1");
        checkLocation(&loc, 1, 1, 1, 4, t + "A1_loc");
        checkCharToken(scanner, &compiler, &loc, 'n', 1, t + "A2");
        checkLocation(&loc, 1, 5, 1, 8, t + "A2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "A3");
        checkLocation(&loc, 1, 8, 1, 9, t + "A3_loc");
        checkCharToken(scanner, &compiler, &loc, '\'', 1, t + "A4");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkCharToken(scanner, &compiler, &loc, 0xcf8e, 2, t + "B1");
        checkLocation(&loc, 1, 1, 1, 5, t + "B1_loc");
        checkCharToken(scanner, &compiler, &loc, 0xcf8b, 2, t + "B2");
        checkLocation(&loc, 1, 6, 1, 10, t + "B2_loc");
        checkCharToken(scanner, &compiler, &loc, 0xcf80, 2, t + "B3");
        checkLocation(&loc, 1, 11, 1, 15, t + "B3_loc");
        checkCharToken(scanner, &compiler, &loc, 0xc3bc, 2, t + "B4");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkCharToken(scanner, &compiler, &loc, 0xf0a09c8e, 4, t + "C1");
        checkLocation(&loc, 1, 1, 1, 7, t + "C1_loc");
        checkCharToken(scanner, &compiler, &loc, 0xf0a18799, 4, t + "C2");
        checkLocation(&loc, 1, 8, 1, 14, t + "C2_loc");
        checkCharToken(scanner, &compiler, &loc, 0xf09f988c, 4, t + "C3");
        checkLocation(&loc, 1, 15, 1, 21, t + "C3_loc");
        checkCharToken(scanner, &compiler, &loc, 0xf09f998b, 4, t + "C4");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkCharToken(scanner, &compiler, &loc, '\n', 1, t + "D1");
        checkLocation(&loc, 1, 1, 1, 5, t + "D1_loc");
        checkCharToken(scanner, &compiler, &loc, '\t', 1, t + "D2");
        checkLocation(&loc, 1, 6, 1, 10, t + "D2_loc");
        checkCharToken(scanner, &compiler, &loc, '\r', 1, t + "D3");
        checkLocation(&loc, 1, 11, 1, 15, t + "D3_loc");
        checkCharToken(scanner, &compiler, &loc, '\f', 1, t + "D4");
        checkLocation(&loc, 1, 16, 1, 20, t + "D4_loc");
        checkCharToken(scanner, &compiler, &loc, '\\', 1, t + "D5");
        checkLocation(&loc, 1, 21, 1, 25, t + "D5_loc");
        checkCharToken(scanner, &compiler, &loc, '\b', 1, t + "D6");
        checkLocation(&loc, 1, 26, 1, 30, t + "D6_loc");
        checkCharToken(scanner, &compiler, &loc, '\0', 1, t + "D7");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "E2");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "F2");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "G2");
    ...
    private: static void parseStringTest(const std::string& t) {
        ...
        EulScanner scanner(&stream);
        checkStringToken(scanner, &compiler, &loc, "hello world", t + "A1");
        checkLocation(&loc, 1, 1, 1, 14, t + "A1_loc");
        checkIntToken(scanner, &compiler, &loc, 123, 4, 0, t + "A2");
        checkLocation(&loc, 1, 14, 1, 17, t + "A2_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "A3");
        checkLocation(&loc, 1, 17, 2, 1, t + "A3_loc");
        checkStringToken(scanner, &compiler, &loc, "multi\nline\n\nstring", t + "A4");
        checkLocation(&loc, 2, 1, 5, 8, t + "A4_loc");
        checkIdToken(scanner, &compiler, &loc, "end", t + "A5");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkStringToken(scanner, &compiler, &loc, "start escaped\n123\tabc\rhello\fworld\n\\backslashes\bxyz", t + "B1");
        checkLocation(&loc, 1, 1, 2, 20, "B1_loc");
        checkIdToken(scanner, &compiler, &loc, "end", t + "B2");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "C2");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ERROR, t + "D2");
    ...
    private: static void parseOperatorsTest(const std::string& t) {
        ...
        checkIntToken(scanner, &compiler, &loc, 1, 4, 0, t + "A3");
        checkLocation(&loc, 1, 3, 1, 4, t + "A3_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::MINUS, t + "A4");
        checkLocation(&loc, 1, 4, 1, 5, t + "A4_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PARENTHESIS_OPEN, t + "A5");
        checkLocation(&loc, 1, 5, 1, 6, t + "A5_loc");
        checkIntToken(scanner, &compiler, &loc, 2, 4, 0, t + "A6");
        checkLocation(&loc, 1, 6, 1, 7, t + "A6_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::INCREASE, t + "A7");
        checkLocation(&loc, 1, 7, 1, 9, t + "A7_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PARENTHESIS_CLOSE, t + "A8");
        checkLocation(&loc, 1, 9, 1, 10, t + "A8_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN_PLUS, t + "A9");
        checkLocation(&loc, 1, 11, 1, 13, t + "A9_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "A10");
        checkLocation(&loc, 1, 13, 2, 1, t + "A10_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::DECREASE, t + "A11");
        checkLocation(&loc, 2, 1, 2, 3, t + "A11_loc");
        checkIntToken(scanner, &compiler, &loc, 5, 4, 0, t + "A12");
        checkLocation(&loc, 2, 3, 2, 4, t + "A12_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN_MINUS, t + "A13");
        checkLocation(&loc, 2, 4, 2, 6, t + "A13_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PLUS, t + "A14");
        ...
        scanner.switch_streams(&stream);
        loc.initialize();
        checkIntToken(scanner, &compiler, &loc, 1, 4, 0, t + "B1");
        checkLocation(&loc, 1, 1, 1, 2, t + "B1_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::PERCENT, t + "B2");
        checkLocation(&loc, 1, 2, 1, 3, t + "B2_loc");
        checkIntToken(scanner, &compiler, &loc, 1, 4, 0, t + "B3");
        checkLocation(&loc, 1, 3, 1, 4, t + "B3_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::STAR, t + "B4");
        checkLocation(&loc, 1, 4, 1, 5, t + "B4_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::SQUARE_OPEN, t + "B5");
        checkLocation(&loc, 1, 5, 1, 6, t + "B5_loc");
        checkIntToken(scanner, &compiler, &loc, 2, 4, 0, t + "B6");
        checkLocation(&loc, 1, 6, 1, 7, t + "B6_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN_STAR, t + "B7");
        checkLocation(&loc, 1, 7, 1, 9, t + "B7_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::SQUARE_CLOSE, t + "B8");
        checkLocation(&loc, 1, 9, 1, 10, t + "B8_loc");
        checkTokenType(scanner,&compiler, &loc, yy::EulParser::token::ASSIGN_DIV, t + "B9");
        checkLocation(&loc, 1, 11, 1, 13, t + "B9_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::NL, t + "B10");
        checkLocation(&loc, 1, 13, 2, 1, t + "B10_loc");
        checkIntToken(scanner, &compiler, &loc, 5, 4, 0, t + "B11");
        checkLocation(&loc, 2, 1, 2, 2, t + "B11_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::ASSIGN_MOD, t + "B12");
        checkLocation(&loc, 2, 2, 2, 4, t + "B12_loc");
        checkTokenType(scanner, &compiler, &loc, yy::EulParser::token::SLASH, t + "B13");
        checkLocation(&loc, 2, 4, 2, 5, t + "B13_loc");
        checkIntToken(scanner, &compiler, &loc, 4, 4, 0, t + "B14");
