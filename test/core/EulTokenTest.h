class EulTokenTest {
    ...
    public: static void charTokenTest(const std::string& t) {
        ...
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "A4");
        ...
        str = "'ϋ'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "B1");
        ...
        str = "'π'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "D1");
        Assert::equals(0xcf80, tok.value, t + "D2");
        Assert::equals(2, tok.size, t + "D3");

        str = "'ü'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "F1");
        ...
        str = "'𡇙'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "H1");
        Assert::equalsUnsigned(0xf0a18799, tok.value, t + "H2");
        Assert::equals(4, tok.size, t + "H3");

        str = "'😌'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "I1");
        Assert::equalsUnsigned(0xf09f988c, tok.value, t + "I2");
        Assert::equals(4, tok.size, t + "I3");

        str = "'🙋'";
        tok = EulCharToken(str.c_str(), str.length(), &comp);
        Assert::equals(ErrorType_NO_ERROR, comp.errorCode, t + "J1");
