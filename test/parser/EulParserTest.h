...
class EulParserTest {
    ...
    private: static void varDeclarationTest(const std::string& t) {
        ...
        EulParsingContext ctx(&compiler, compiler.codeGen, file);
        ...
        Assert::eulType(((VarDeclarationStatement*)file->statements->operator[](2))->declarations->operator[](0)->varType, llvm::IntegerType::get(*compiler.program.llvmContext, 16), t + "C9");
        ...
        Assert::eulType(((VarDeclarationStatement*)file->statements->operator[](0))->declarations->operator[](1)->varType, llvm::IntegerType::get(*compiler.program.llvmContext, 64), t + "F3");
    ...
    private: static void ltrSimpleExpressionTest(const std::string& t) {
        ...
        Assert::intToken(inExp->right, 7, 32, false, t + "B1");
    ...
    private: static void ltrMixedPrioritiesTest(const std::string& t) {
        ...
        //3. Assert tree
        Assert::intToken(inExp->left, 1, 32, false, t + "B1");
        Assert::equals(&EUL_OPERATORS.orOperator, inExp->oper, t + "B2");

        inExp = (EulInfixExp*)(inExp->right);
        Assert::intToken(inExp->left, 4, 32, false, t + "C1");
        ...
        Assert::intToken(inExp->left, 5, 32, false, t + "D4");
        inExp = Assert::infixExp(inExp->right, t + "D5");
        Assert::intToken(inExp->left, 8, 32, false, t + "D7");
        Assert::equals(&EUL_OPERATORS.starOperator, inExp->oper, t + "D6");
        Assert::intToken(inExp->right, 10, 32, false, t + "D8");
        ...
        Assert::intToken(inExp->right, 5, 32, false, t + "H2");
    }
    ...
    private: static void infixParenthesisTest(const std::string& t) {
        ...
        Assert::intToken(infixExp->right, 1, 32, false, t + "C3");
    }
    ...
    private: static void functionCallTest(const std::string& t) {
        ...
        Assert::intToken(rootLR->params->at(0), 5, 32, false, t + "B7");
        ...
        Assert::intToken(rootLR2->params->at(0), 6, 32, true, t + "B11");

        //Test right part: 3*x(1)(2)
        EulInfixExp* rootR = Assert::infixExp(root->right, t+"C1");
        Assert::intToken(rootR->left, 3, 32, false, t+"C2");
        ...
        Assert::intToken(rootRR2->params->at(0), 1, 32, false, t + "C8");
    }
    ...
    private: static void arrayAccessTest(const std::string& t) {
        ...
        Assert::intToken(rootLR->index, 5, 32, false, t + "B7");
    ...
    private: static void returnStatementTest(const std::string& t) {
        ...
        ReturnStatement *stmt = Assert::returnStatement(file->statements->operator[](0), t + "A2");
        Assert::null(stmt->exp, t + "A3");

        //2. Assert second statement
        stmt = Assert::returnStatement(file->statements->operator[](1), t + "B1");
        Assert::notNull(stmt->exp, t + "B2");
        EulInfixExp* exp = Assert::infixExp(stmt->exp, t + "B3");
        Assert::equals(&EUL_OPERATORS.plusOperator, exp->oper, t + "B4");
        Assert::intToken(exp->left, 1, 32, false, t + "B5");
        Assert::idToken(exp->right, "x", t + "B6");
    }
