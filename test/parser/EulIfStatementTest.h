...
class EulIfStatementTest {
    ...
    public: static void runAll() {
        singleIfTest("EulIfStatementTest.singleIfTest ");
        ifElseTest("EulIfStatementTest.ifElseTest ");
        ifElseTestWithoutBlock("EulIfStatementTest.ifElseTestWithoutBlock ");
        ifWithTwoElseIfs("EulIfStatementTest.ifWithTwoElseIfs ");
        ifWithTwoElseIfsAndElse("EulIfStatementTest.ifWithTwoElseIfsAndElse ");
    }
};